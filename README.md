...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqllineage-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14980&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqllineage-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqllineage` can be installed with:

```
conda install sqllineage
```

It is possible to list all of the versions of `sqllineage` available on your platform with:
